(() => {
  ...
  function monkey() {
    const path = (d, fill, extra = {}) => element("path", {
      d, fill, stroke: "#482b21", "stroke-width": 5, "stroke-linecap": "round", "stroke-linejoin": "round", ...extra,
    });
    const ellipse = (cx, cy, rx, ry, fill, extra = {}) => element("ellipse", { cx, cy, rx, ry, fill, ...extra });
    const svg = element("svg", { viewBox: "0 0 280 280", "aria-hidden": "true", class: "capuchin" });
    const body = element("g", { class: "monkey-body" }, [
      ...
      element("g", { class: "monkey-head" }, [
        ...
        path("M81 105 C75 58 102 32 139 33 C178 30 204 61 201 108 L194 142 Q182 168 140 170 Q94 168 84 143 Z", "#765039"),
        ...
        path("M115 43 Q108 28 120 27 L135 38 Q132 17 143 22 L155 39", "#765039"),
      ]),
    ]);
    svg.append(body);
    return svg;
  ...
  globalThis.bananaFeedArt = Object.freeze({ banana, monkey, bananaPath });
})();
