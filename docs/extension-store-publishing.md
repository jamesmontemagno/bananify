...
| Store listing identifiers | Recorded in the [submission kit](../store/README.md#5-keep-these-non-secret-details-for-later-api-setup); public URLs still pending |
